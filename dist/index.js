/*!
  react-datepicker v8.9.0-hotfix.5437
...
function safeDateRangeFormat(startDate, endDate, props) {
  ...
  return ""
    .concat(formattedStartDate)
    .concat(dateRangeSeparator)
  ...
  function Day() {
    ...
    _this.isSelectingRangeStart = function () {
      ...
      if (selectsRange && swapRange && startDate && selectingDate) {
        return isSameDay(
          day,
          dateFns.isBefore(selectingDate, startDate)
            ? selectingDate
            : startDate,
        );
      }
...
var Week = /** @class */ (function (_super) {
  ...
  Week.prototype.render = function () {
    ...
    return React__default.default.createElement(
      "div",
      {
        className: clsx.clsx(weekNumberClasses, customWeekClassName),
        role: "row",
      },
      this.renderDays(),
    );
  ...
  function Month() {
    ...
    _this.isQuarterSelected = function () {
      ...
      if (selectsMultiple) {
        return selectedDates === null || selectedDates === void 0
          ? void 0
          : selectedDates.some(function (selectedDate) {
      ...
      switch (e.key) {
        ...
        case "ArrowDown": {
          ...
          var newMonth =
            ...
            _this.props.monthNames.length;
          (_a = _this.monthOptionButtonsRef[newMonth]) === null || _a === void 0
            ? void 0
            : _a.focus();
          break;
        }
...
var Year = /** @class */ (function (_super) {
  ...
  function Year(props) {
    ...
    _this.isKeyboardSelected = function (y) {
      ...
      var isKeyboardSelectedDay = isSameDay(
        date,
        getStartOfYear(_this.props.preSelection),
      );
      return (
        !_this.props.inline &&
        !isSelectedDay &&
      ...
      switch (e.key) {
        ...
        case "ArrowDown": {
          ...
          if (_this.yearOptionButtonsRef[newYear]) {
            (_a = _this.yearOptionButtonsRef[newYear]) === null || _a === void 0
              ? void 0
              : _a.focus();
          }
          break;
...
var Calendar = /** @class */ (function (_super) {
  ...
  function Calendar(props) {
        ...
        [0, 1, 2, 3, 4, 5, 6].map(function (offset) {
          ...
          return React__default.default.createElement(
            ...
            React__default.default.createElement(
              "span",
              { className: "react-datepicker__sr-only" },
              formatDate(day, "EEEE", _this.props.locale),
            ),
            React__default.default.createElement(
              "span",
              { "aria-hidden": "true" },
    ...
    _this.renderCustomHeader = function (headerArgs) {
      ...
      var _c = _this.props,
        showYearPicker = _c.showYearPicker,
        yearItemNumber = _c.yearItemNumber;
        ...
        (_b = (_a = _this.props).renderCustomHeader) === null || _b === void 0
          ...
          : _b.call(
              ...
              _assign(
                _assign(
                  _assign({}, _this.state),
                  showYearPicker && { visibleYearsRange: visibleYearsRange },
                ),
                {
                  customHeaderCount: i,
                  monthDate: monthDate,
...
function withFloating(Component) {
  ...
  WithFloating.displayName = "withFloating(".concat(
...
var PopperComponent = function (props) {
  var className = props.className,
    ...
    _a = props.hidePopper,
    hidePopper = _a === void 0 ? true : _a,
    popperComponent = props.popperComponent,
    targetComponent = props.targetComponent,
    enableTabLoop = props.enableTabLoop,
    popperOnKeyDown = props.popperOnKeyDown,
  ...
  function DatePicker(props) {
    ...
    _this.getInputValue = function () {
      ...
      var _b = _this.props,
        ...
        startDate = _b.startDate,
        endDate = _b.endDate,
        rangeSeparator = _b.rangeSeparator,
        selected = _b.selected,
        selectedDates = _b.selectedDates,
        selectsMultiple = _b.selectsMultiple,
        selectsRange = _b.selectsRange,
        value = _b.value;
      var dateFormat =
      ...
      if (typeof value === "string") {
        ...
        return safeMultipleDatesFormat(
    ...
    _this.handleSelect = function (date, event, monthSelectedIn) {
      ...
      var dateFormat =
        (_a = _this.props.dateFormat) !== null && _a !== void 0
          ? _a
          : DatePicker.defaultProps.dateFormat;
      var isDateSelectionComplete =
        !selectsRange ||
        (startDate &&
          !endDate &&
          (swapRange || !isDateBefore(date, startDate)));
      if (
      ...
      var className = clsx.clsx(
        ...
        (_a[
          _this.props.outsideClickIgnoreClass ||
            DatePicker.defaultProps.outsideClickIgnoreClass
        ] = _this.state.open),
        _a),
      );
      var customInput =
